...
def get_sic_scores_per_inst(inst_name):
    sql="""select * from h2020_sic_scores_per_inst 
...
def get_average_major_and_minor_sic_for_all_insts():
    "returns average major and minor sic scores for all the insts"
